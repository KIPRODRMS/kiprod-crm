...
export default function GlobalSearch({
  ...
  return (
    <div
      ref={wrapperRef}
      className="crm-global-search relative ml-auto min-w-0 flex-1 md:max-w-xl"
    >
      <form
        action="/search"
        method="get"
      ...
      >
        <input
          ...
          className="w-full min-w-0 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm text-slate-950 outline-none transition placeholder:text-slate-500 focus:border-amber-400 focus:bg-white focus:ring-4 focus:ring-amber-500/10"
        />

        <button
          type="submit"
          disabled={!userId || trimmedQuery.length === 0}
